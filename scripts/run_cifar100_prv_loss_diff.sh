#!/bin/bash
# run cifar-100 with loss_diff baseline and previous task samples

export CUBLAS_WORKSPACE_CONFIG=:4096:8

# parameters matching run_cifar100_prv.sh
...
local_path='./results/split_cifar100_prv_loss_diff/test1'

# create logs directory if it doesn't exist
mkdir -p logs

# redirect all output to log file
exec > logs/cifar100_prv_loss_diff.out 2>&1
