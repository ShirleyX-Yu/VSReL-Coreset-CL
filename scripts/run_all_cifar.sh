...
bash scripts/run_cifar_qvendi.sh > "${PROJECT_ROOT}/logs/cifar_qvendi.out" 2>&1
echo "✓ completed cifar_qvendi"
echo ""

echo "running cifar_loss_diff..."
bash scripts/run_cifar_loss_diff.sh > "${PROJECT_ROOT}/logs/cifar_loss_diff.out" 2>&1
echo "✓ completed cifar_loss_diff"
echo ""

echo "running cifar_prv_qvendi..."
bash scripts/run_cifar_prv_qvendi.sh > "${PROJECT_ROOT}/logs/cifar_prv_qvendi.out" 2>&1
echo "✓ completed cifar_prv_qvendi"
echo ""

echo "running cifar_prv_loss_diff..."
bash scripts/run_cifar_prv_loss_diff.sh > "${PROJECT_ROOT}/logs/cifar_prv_loss_diff.out" 2>&1
